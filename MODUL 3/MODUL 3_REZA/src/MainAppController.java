...
public class MainAppController {
    ...
    public void initialize() {
        ...
        titleCol.setCellValueFactory(new PropertyValueFactory<>(property:"title"));
        dueDateCol.setCellValueFactory(new PropertyValueFactory<>(property:"duedate"));
        priorityCol.setCellFactory(new PropertyValueFactory<>(property:"priority"));
        statusCol.setCellFactory(new PropertyValueFactory<>(property:"status"));
    ...
    private void addTask() {
        try {
            ...
            if (dueDatePicker.getValue().isBefore(LocalDate.now())) {
                ...
                throw new InvalidMidiDataException("Salah");
            }
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("salah");
            }
